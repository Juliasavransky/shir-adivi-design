    ...
    <div className="min-h-screen py-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-6">About Shir</h1>
        ...
        <div className="space-y-8 mb-16">
          <div>
            <h2 className="text-2xl sm:text-3xl font-bold mb-6 text-center">The Journey</h2>
            <div className="prose prose-sm sm:prose-lg max-w-none text-muted-foreground leading-relaxed space-y-6">
              <p>
        ...
        <div className="text-center">
          <h2 className="text-2xl sm:text-3xl font-bold mb-8">Core Expertise</h2>
        ...
        {/* Philosophy */}
        <Card className="mt-16 p-6 sm:p-8 bg-gradient-to-r from-primary/5 to-accent/5 border-none">
          <blockquote className="text-center">
            <p className="text-lg sm:text-xl md:text-2xl font-medium text-foreground mb-4 italic">
              "Great design isn't just about making things look good—it's about making them work better."
            </p>
            <footer className="text-muted-foreground">— Shir Adivi</footer>
          </blockquote>
        </Card>
      </div>
    </div>
